use css_bitvector_compiler::{
    ...
    TraceFrame, attributes_to_string_map, derive_hover_state, extract_pseudoclasses, generate_nfa,
...
fn main() {
    ...
    report_unsupported_selectors("rec_tri", &parsed.unsupported_selectors);
