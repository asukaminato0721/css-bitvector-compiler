...
// Rule 214: CheckAndSetBit { selector: Type("input"), bit_pos: 214 }
pub fn matches_rule_214(node: &HtmlNode) -> bool {
    node.tag_name == "input"
}

// Rule 216: CheckAndSetBit { selector: Type("td"), bit_pos: 216 }
...
pub fn process_tree_naive(root: &mut HtmlNode) -> usize {
    ...
    let empty_parent = vec![false; 218];
