...
pub const BITVECTOR_CAPACITY: usize = 900;
...
fn get_string_to_id_map() -> &'static HashMap<&'static str, u32> {
    STRING_TO_ID.get_or_init(|| {
        ...
        map.insert("icp-touch-link-country", 443);
        ...
        map.insert("icp-touch-link-language", 444);
        ...
        map.insert("icp-touch-link-cop", 442);
        ...
        map.insert("single-slide-hero", 436);
        ...
        map.insert("nav-timeline-prime-icon", 435);
...
pub fn process_node_generated_incremental(
    ...
    if node.cached_node_intrinsic.is_none() || node.is_self_dirty {
        ...
        if matches_class_id(node, 423) {
            intrinsic_matches.set_bit(846); // match_Class("card-flow-row-break")
        }

        // Instruction 848: CheckAndSetBit { selector: Class("gbmt"), bit_pos: 848 }
        if matches_class_id(node, 424) {
            intrinsic_matches.set_bit(848); // match_Class("gbmt")
        }

        // Instruction 850: CheckAndSetBit { selector: Class("gbts"), bit_pos: 850 }
        if matches_class_id(node, 425) {
            intrinsic_matches.set_bit(850); // match_Class("gbts")
        }

        // Instruction 852: CheckAndSetBit { selector: Class("gw-auto-height"), bit_pos: 852 }
        if matches_class_id(node, 426) {
            intrinsic_matches.set_bit(852); // match_Class("gw-auto-height")
        }

        // Instruction 854: CheckAndSetBit { selector: Class("gw-card-layout"), bit_pos: 854 }
        if matches_class_id(node, 427) {
            intrinsic_matches.set_bit(854); // match_Class("gw-card-layout")
        }

        // Instruction 856: CheckAndSetBit { selector: Class("gw-col"), bit_pos: 856 }
        if matches_class_id(node, 428) {
            intrinsic_matches.set_bit(856); // match_Class("gw-col")
        }

        // Instruction 858: CheckAndSetBit { selector: Class("gw-fixed-col"), bit_pos: 858 }
        if matches_class_id(node, 429) {
            intrinsic_matches.set_bit(858); // match_Class("gw-fixed-col")
        }

        // Instruction 860: CheckAndSetBit { selector: Class("gw-media-card"), bit_pos: 860 }
        if matches_class_id(node, 430) {
            intrinsic_matches.set_bit(860); // match_Class("gw-media-card")
        }

        // Instruction 862: CheckAndSetBit { selector: Class("gw-row"), bit_pos: 862 }
        if matches_class_id(node, 431) {
            intrinsic_matches.set_bit(862); // match_Class("gw-row")
        }

        // Instruction 864: CheckAndSetBit { selector: Class("lsb"), bit_pos: 864 }
        if matches_class_id(node, 432) {
            intrinsic_matches.set_bit(864); // match_Class("lsb")
        }

        // Instruction 866: CheckAndSetBit { selector: Class("nav-focus"), bit_pos: 866 }
        if matches_class_id(node, 433) {
            intrinsic_matches.set_bit(866); // match_Class("nav-focus")
        }

        // Instruction 868: CheckAndSetBit { selector: Class("nav-spinner"), bit_pos: 868 }
        if matches_class_id(node, 434) {
            intrinsic_matches.set_bit(868); // match_Class("nav-spinner")
        }

        // Instruction 870: CheckAndSetBit { selector: Class("nav-timeline-prime-icon"), bit_pos: 870 }
        if matches_class_id(node, 435) {
            intrinsic_matches.set_bit(870); // match_Class("nav-timeline-prime-icon")
        }

        // Instruction 872: CheckAndSetBit { selector: Class("single-slide-hero"), bit_pos: 872 }
        if matches_class_id(node, 436) {
            intrinsic_matches.set_bit(872); // match_Class("single-slide-hero")
        }

        // Instruction 874: CheckAndSetBit { selector: Class("truncate-1line"), bit_pos: 874 }
        if matches_class_id(node, 437) {
            intrinsic_matches.set_bit(874); // match_Class("truncate-1line")
        }

        // Instruction 876: CheckAndSetBit { selector: Class("truncate-2line"), bit_pos: 876 }
        if matches_class_id(node, 438) {
            intrinsic_matches.set_bit(876); // match_Class("truncate-2line")
        }

        // Instruction 878: CheckAndSetBit { selector: Class("vjs-fluid"), bit_pos: 878 }
        if matches_class_id(node, 439) {
            intrinsic_matches.set_bit(878); // match_Class("vjs-fluid")
        }

        // Instruction 880: CheckAndSetBit { selector: Id("gb"), bit_pos: 880 }
        if matches_id_id(node, 440) {
            intrinsic_matches.set_bit(880); // match_Id("gb")
        }

        // Instruction 882: CheckAndSetBit { selector: Id("gbz"), bit_pos: 882 }
        if matches_id_id(node, 441) {
            intrinsic_matches.set_bit(882); // match_Id("gbz")
        }

        // Instruction 884: CheckAndSetBit { selector: Id("icp-touch-link-cop"), bit_pos: 884 }
        if matches_id_id(node, 442) {
            intrinsic_matches.set_bit(884); // match_Id("icp-touch-link-cop")
        }

        // Instruction 886: CheckAndSetBit { selector: Id("icp-touch-link-country"), bit_pos: 886 }
        if matches_id_id(node, 443) {
            intrinsic_matches.set_bit(886); // match_Id("icp-touch-link-country")
        }

        // Instruction 888: CheckAndSetBit { selector: Id("icp-touch-link-language"), bit_pos: 888 }
        if matches_id_id(node, 444) {
            intrinsic_matches.set_bit(888); // match_Id("icp-touch-link-language")
        }

        // Instruction 890: CheckAndSetBit { selector: Type("a"), bit_pos: 890 }
        if matches_tag_id(node, 445) {
            intrinsic_matches.set_bit(890); // match_Type("a")
        }

        // Instruction 892: CheckAndSetBit { selector: Type("div"), bit_pos: 892 }
        if matches_tag_id(node, 446) {
            intrinsic_matches.set_bit(892); // match_Type("div")
        }

        // Instruction 894: CheckAndSetBit { selector: Type("h3"), bit_pos: 894 }
        if matches_tag_id(node, 447) {
            intrinsic_matches.set_bit(894); // match_Type("h3")
        }

        // Instruction 896: CheckAndSetBit { selector: Type("input"), bit_pos: 896 }
        if matches_tag_id(node, 448) {
            intrinsic_matches.set_bit(896); // match_Type("input")
        }

        // Instruction 898: CheckAndSetBit { selector: Type("span"), bit_pos: 898 }
        if matches_tag_id(node, 449) {
            intrinsic_matches.set_bit(898); // match_Type("span")
        }
    ...
    if current_matches.is_bit_set(848) {
        child_states.set_bit(849); // active_Class("gbmt")
    }
    if current_matches.is_bit_set(850) {
        child_states.set_bit(851); // active_Class("gbts")
    }
    if current_matches.is_bit_set(852) {
        child_states.set_bit(853); // active_Class("gw-auto-height")
    }
    if current_matches.is_bit_set(854) {
        child_states.set_bit(855); // active_Class("gw-card-layout")
    }
    if current_matches.is_bit_set(856) {
        child_states.set_bit(857); // active_Class("gw-col")
    }
    if current_matches.is_bit_set(858) {
        child_states.set_bit(859); // active_Class("gw-fixed-col")
    }
    if current_matches.is_bit_set(860) {
        child_states.set_bit(861); // active_Class("gw-media-card")
    }
    if current_matches.is_bit_set(862) {
        child_states.set_bit(863); // active_Class("gw-row")
    }
    if current_matches.is_bit_set(864) {
        child_states.set_bit(865); // active_Class("lsb")
    }
    if current_matches.is_bit_set(866) {
        child_states.set_bit(867); // active_Class("nav-focus")
    }
    if current_matches.is_bit_set(868) {
        child_states.set_bit(869); // active_Class("nav-spinner")
    }
    if current_matches.is_bit_set(870) {
        child_states.set_bit(871); // active_Class("nav-timeline-prime-icon")
    }
    if current_matches.is_bit_set(872) {
        child_states.set_bit(873); // active_Class("single-slide-hero")
    }
    if current_matches.is_bit_set(874) {
        child_states.set_bit(875); // active_Class("truncate-1line")
    }
    if current_matches.is_bit_set(876) {
        child_states.set_bit(877); // active_Class("truncate-2line")
    }
    if current_matches.is_bit_set(878) {
        child_states.set_bit(879); // active_Class("vjs-fluid")
    }
    if current_matches.is_bit_set(880) {
        child_states.set_bit(881); // active_Id("gb")
    }
    if current_matches.is_bit_set(882) {
        child_states.set_bit(883); // active_Id("gbz")
    }
    if current_matches.is_bit_set(884) {
        child_states.set_bit(885); // active_Id("icp-touch-link-cop")
    }
    if current_matches.is_bit_set(886) {
        child_states.set_bit(887); // active_Id("icp-touch-link-country")
    }
    if current_matches.is_bit_set(888) {
        child_states.set_bit(889); // active_Id("icp-touch-link-language")
    }
    if current_matches.is_bit_set(890) {
        child_states.set_bit(891); // active_Type("a")
    }
    if current_matches.is_bit_set(892) {
        child_states.set_bit(893); // active_Type("div")
    }
    if current_matches.is_bit_set(894) {
        child_states.set_bit(895); // active_Type("h3")
    }
    if current_matches.is_bit_set(896) {
        child_states.set_bit(897); // active_Type("input")
    }
    if current_matches.is_bit_set(898) {
        child_states.set_bit(899); // active_Type("span")
    }
